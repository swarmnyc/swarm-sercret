<!-- WHAT YOU WANT TO DO IS GO AHEAD AND CREATE A TWITTER WIDGET, THE BELOW SCRIPT WILL OULL OUT THE TWEETS AND PLACE THEM IN THE BODY OF THIS PAGE 
	   ...
	   YOUR TWITTER WIDGET CODE SHOULD LOOK LIKE THIS 
	    ...
	    <a class="twitter-timeline" href="https://twitter.com/SwarmBOT5000" data-widget-id="515939974244352000">Tweets by @SwarmBOT5000</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
	    
	    IDENTIFY THE data-widget-id VARIABLE AND PUT IT INTO 
    -->
...
//twitterFetcher.fetch('557578081511014400', 'tweets', 20, true, false, false);
twitterFetcher.fetch('515939974244352000', 'tweets', 40, true, false, false);

        
twitterFetcher.fetch('557578081511014400', 'funfun', 100, true, false, false);
